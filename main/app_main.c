...
void connected_cb(void *self, void *params)
{
    ...
    mqtt_subscribe(client, "owlcreation/test", 0);
    mqtt_publish(client, "owlcreation/test", "howdy!", 6, 0, 0);
}
...
void subscribe_cb(void *self, void *params)
{
    ...
    mqtt_client *client = (mqtt_client *)self;
    mqtt_publish(client, "owlcreation/test", "abcde", 5, 0, 0);
}
...
#endif    
    .client_id = "{7AE7320B-D817-470A-8873-A091B3A21FF9}",
//    .username = "user",
//    .password = "pass",
    .clean_session = 0,
    .keepalive = 120,
    .lwt_topic = "owlcreation/lwt",
    .lwt_msg = "offline",
    .lwt_qos = 0,
    .lwt_retain = 0,
